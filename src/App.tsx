  ...
  return (
    <ErrorBoundary>
      ...
      <Modal
        ...
        title="Configuration"
        description="Manage your home lab endpoints"
        darkMode={darkMode}
        footer={
            ...
            <div className={`p-6 rounded-3xl border flex items-center justify-between transition-colors ${darkMode ? "bg-zinc-900 border-zinc-800" : "bg-gray-50 border-gray-100"}`}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className={`text-[10px] uppercase tracking-widest font-medium ${darkMode ? "text-zinc-500" : "text-gray-400"}`}>
      ...
      <Modal
        isOpen={isSingleEditOpen && !!singleEditApp}
        onClose={() => setIsSingleEditOpen(false)}
        title="Edit Application"
        description={`Configure ${singleEditApp?.name || "New Application"}`}
        darkMode={darkMode}
        footer={
